...
export default function Contact() {
  ...
  return (
    <div id="contact" className="flex flex-col items-center justify-center mb-40">
      ...
      <div className="bg-gray-900 w-2/3 m-auto rounded-lg p-16 flex justify-between">
        <div className="flex flex-col w-2/4">
          ...
          <div className="flex flex-row mt-4 gap-4">
            <a href="https://www.instagram.com/levidlima/" className="hover:text-purple-900 transition-all">
              <InstagramLogo size={32} />
            </a>
            <a href="https://github.com/DEVLevid" className="hover:text-purple-900 transition-all">
              <GithubLogo size={32} />
            </a>
            <a href="www.linkedin.com/in/levid-lima-326311260" className="hover:text-purple-900 transition-all">
        ...
        >
          ...
          <textarea
            ...
            className="bg-transparent h-20 border-2 p-2 rounded-lg overflow-auto"
          ></textarea>
